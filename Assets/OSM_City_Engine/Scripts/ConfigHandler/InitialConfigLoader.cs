...
namespace Assets.Scripts.ConfigHandler
{
    ...
    class InitialConfigLoader
    {
        ...
        {
            if(!Directory.Exists(Path.Combine(Application.streamingAssetsPath, "ConfigFiles/" )))
                Directory.CreateDirectory(Path.Combine(Application.streamingAssetsPath,"ConfigFiles/"));
        }
        ...
        public InitialConfigurations loadInitialConfig()
        {
            ...
            string path = Path.Combine(Application.streamingAssetsPath, "ConfigFiles/initialConfig.xml");
            if(File.Exists(path))
            {
                var encoding = Encoding.GetEncoding("UTF-8");
            ...
            else
            {
                    ...
                    saveInitialConfig(Path.Combine(Application.streamingAssetsPath, "ConfigFiles/initialConfig.xml"), config);
                    return config;
            }
