    ...
    public class Barrier
    {
        ...
        private void generateWall(Way way)
        {
            for (int i = 0; i < way.nodes.Count - 1; i++)
            {
                ...
                Vector2[] UVcoords = new Vector2[] {new Vector2(0.0f,0.0f), new Vector2(magnitude/20.0f,0.0f), 
                                                    new Vector2(magnitude/20.0f,1.0f), new Vector2(0.0f,1.0f),
                                                    new Vector2(0.0f,0.0f), new Vector2(magnitude/20.0f,0.0f), 
                                                    new Vector2(magnitude/20.0f,1.0f), new Vector2(0.0f,1.0f),
                                                    new Vector2(0.0f,0.0f), new Vector2(magnitude/20.0f,0.0f), 
                                                    new Vector2(magnitude/20.0f,0.1f), new Vector2(0.0f,0.1f),
                                                    new Vector2(0.0f,0.0f), new Vector2(0.1f,0.0f), 
                                                    new Vector2(0.1f,1.0f), new Vector2(0.0f,1.0f),
                                                    new Vector2(0.0f,0.0f), new Vector2(0.1f,0.0f), 
                                                    new Vector2(0.1f,1.0f), new Vector2(0.0f,1.0f),
                                                   };
                ...
                {
                    Debug.Log("Highway Mesh is empty " + Wall.name);
                }
                else
                {
